  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved history as @history" do
        ...
        post :create, {:history => { "incident_no" => "invalid value" }}, valid_session
        assigns(:history).should be_a_new(History)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested history" do
        ...
        History.any_instance.should_receive(:update_attributes).with({ "incident_no" => "1" })
        put :update, {:id => history.to_param, :history => { "incident_no" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the history as @history" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        History.any_instance.stub(:save).and_return(false)
        put :update, {:id => history.to_param, :history => { "incident_no" => "invalid value" }}, valid_session
        assigns(:history).should eq(history)
      end
